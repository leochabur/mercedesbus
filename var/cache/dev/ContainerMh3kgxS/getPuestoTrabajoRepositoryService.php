 ...
 */
class getPuestoTrabajoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RRHH\PuestoTrabajoRepository' shared autowired service.
     *
     * @return \App\Repository\RRHH\PuestoTrabajoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RRHH'.\DIRECTORY_SEPARATOR.'PuestoTrabajoRepository.php';

        return $container->privates['App\\Repository\\RRHH\\PuestoTrabajoRepository'] = new \App\Repository\RRHH\PuestoTrabajoRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
